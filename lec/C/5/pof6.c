...
//int (*) (char *, int *, int *)
//((int (*) (char *, int *, int *))sys_call_table[1])(d,3,3)
int test_open(char *str, int meta1, int meta2)
{
...
void kill_proc(int signum1)
{
	printf("signum = %d\n", signum1);
}

// void (*)(int) my_signal(int signum, void (* handler)(int))
// void (*)(int) (*)(int signum, void (* handler)(int)) // 원형
// void ((* 
...
void syscall(int syscall_num)
{
	...
	{	
		...
		case 0:	/* int (*)(char *) - 홀수 */
			...
			if(randnum % 2)
			{
				// my_open() //sys_call_table 이 void형식 = 형변환이 필요하거든
